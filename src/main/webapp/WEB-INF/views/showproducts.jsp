...
<div class="container">
  ...
  <sptags:form class="form-horizontal" action="addProduct" method="post" commandName="pro" enctype="multipart/form-data" >
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <sptags:input path="productName" class="form-control"  placeholder="Enter productName" />
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="productCategory">productCategory:</label>
      <div class="col-sm-10">          
        <sptags:input path="productCategory" class="form-control"  placeholder="Enter productCategory" />
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="productCategory">productPrice:</label>
      <div class="col-sm-10">          
        <sptags:input path="productPrice" class="form-control"  placeholder="Enter productPrice" />
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="productCategory">productDescription:</label>
      <div class="col-sm-10">          
        <sptags:input path="productDescription" class="form-control"  placeholder="Enter productDescription" />
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="productSupplierName">productSupplierName:</label>
      <div class="col-sm-10">          
        <sptags:input path="productSupplierName" class="form-control"  placeholder="Enter productSupplierName" />
      </div>
    </div>
   ...
   <thead class="thead-dark">
    ...
    <tbody>
      ...
      <tr class="table-primary">
        ...
        <td><img src="resources/${p.productId }.jpg" alt="abc" style="width:100px;height:100px;"></td>
